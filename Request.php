...
class Request
{
     ...
     */
    public function enableProxy($proxy_host, $proxy_port, $proxy_username, $proxy_password, $proxy_type = "http")
    {
        $this->proxyEnabled = TRUE;
        $this->proxyHost = $proxy_host;
        $this->proxyPort = $proxy_port;
        $this->proxyUsername = $proxy_username;
    ...
    public function execute()
    {
        ...
        // If proxy are enabled, use them.
        if ($this->proxyEnabled) {
            if (!empty($this->proxyHost) && !empty($this->proxyPort)) {
                curl_setopt($ch, CURLOPT_PROXY, "{$this->proxyHost}:{$this->proxyPort}");
            }
            if (!empty($this->proxyPassword) && !empty($this->proxyUsername)) {
        ...
        if (isset($this->requestType)) {
            ...
            if ($this->requestType == 'PUT' && isset($this->postFields)) {
                curl_setopt($ch, CURLOPT_POSTFIELDS, $this->postFields);
            }
        }
