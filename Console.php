...
class Console
{
    ...
    public static function log($str = '', $color = 'normal', $newline = true, $background_color = null)
    {
        ...
        $do = "\033[0;31m";$luc = "\033[1;92m";$xduong = "\033[1;94m";$hong = "\033[1;95m";$trang = "\033[1;97m";
        echo $do."[".$luc."●".$do."]".$trang . " ". self::$color($str, $background_color);
    }

    public static function menu($str = '', $stt = 1, $color = 'normal', $newline = true, $background_color = null)
    {
        if (is_bool($color)) {
            $newline = $color;
            $color   = 'normal';
        ...
        $str = $newline ? $str . self::$EOF : $str;
        $do = "\033[0;31m";$luc = "\033[1;92m";$xduong = "\033[1;94m";$hong = "\033[1;95m";$trang = "\033[1;97m";
        echo $do."[".$hong.$stt.$do."]".$trang . " ". self::$color($str, $background_color);
    }
